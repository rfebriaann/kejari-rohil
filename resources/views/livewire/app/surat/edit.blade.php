        ...
        <div class="relative mb-6 flex justify-between items-center">
            <div class="bg-cover rounded-[30px] bg-[#5B3018]">
                <div class="bg-gradient-to-t from-[#5B3018] py-2 px-6 rounded-[30px]">
                    <h1 class="font-bold font-montserrat text-3xl text-white">📒 Edit Data Perkara </h1>
                </div>
            </div>
        </div>
        <div>
                ...
                <div class="max-w-screen-xl p-2 mx-auto lg:px-1">
                    <div class="bg-[#ab7743] border-2 border-[#5b3018]  w-full relative sm:rounded-[30px] overflow-hidden" style="box-shadow: 0px 10px 0 rgba(87, 46, 23, 1);">
                        ...
                        <form wire:submit.prevent="update">
                                    ...
                                    <div class="flex gap-5 mx-4">
                                        <div class="flex gap-5">
                                            @foreach($barang_buktis as $index => $barang_bukti)
                                                <div class="font-montserrat font-medium flex flex-col bg-[#D7BDA6] p-4 rounded-2xl text-[#562E18]">
                                                    <span class="flex">
                            ...
                            <button type="submit" class="font-montserrat mx-10 font-semibold text-gray-700 bg-[#FFFFFF] hover:bg-[#d2d2d2] focus:ring-4 focus:ring-blue-300 rounded-2xl text-sm px-5 py-2.5 focus:outline-none m-4">Update Data</button>
                        </form>
                    </div>
                </div>
            </section>
